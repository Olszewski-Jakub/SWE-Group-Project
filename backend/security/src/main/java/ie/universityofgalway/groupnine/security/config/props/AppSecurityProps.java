...
public class AppSecurityProps {
    ...
    public static class Routes {
        ...
        public List<PublicRoute> getPublicRoutes() { return publicRoutes; }
        public void setPublicRoutes(List<PublicRoute> publicRoutes) { this.publicRoutes = publicRoutes; }
        public List<SecureRoute> getSecureRoutes() { return secureRoutes; }
        public void setSecureRoutes(List<SecureRoute> secureRoutes) { this.secureRoutes = secureRoutes; }
    }
    ...
    public static class PublicRoute {
        ...
        public PublicRoute() {}
        public PublicRoute(String pattern) { this.pattern = pattern; }
    ...
    public static class Jwt {
        ...
        public java.time.Duration getAccessTokenTtl() { return accessTokenTtl; }
        public void setAccessTokenTtl(java.time.Duration accessTokenTtl) { this.accessTokenTtl = accessTokenTtl; }
    }
}
